The main menu of the game gives the players three options to choose from. These options are Encounter, Campsite and Shop. The players will use keyboard input keys to access these options.
