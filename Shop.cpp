...
Shop::Shop() {
  ...
  inventory.push_back(Items("Reaper's Blade", 200));
  inventory.push_back(Items("Ring of Fire", 200));
  inventory.push_back(Items("Holy Water", 200));
  inventory.push_back(Items("Life Essence", 400));
  inventory.push_back(Items("Action Boost", 400));
  inventory.push_back(Items("Second Chance", 400));
}
